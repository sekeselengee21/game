/* eslint-disable react-refresh/only-export-components -- provider co-locates its Context and useMyTables hook; the only-export-components rule affects dev-time Fast Refresh only, not the build. */
import {
  createContext,
  useContext,
  useState,
